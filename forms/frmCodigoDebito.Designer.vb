...
Partial Class frmCodigoDebito
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtDetalleCodDeb.TabIndex = 4
        '
        'txtObsCodDeb
        '
        ...
        Me.txtImporteCodDeb.TabIndex = 6
