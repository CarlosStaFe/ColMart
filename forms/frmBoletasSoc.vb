...
Public Class frmBoletasSoc
    ...
    Private Sub frmBoletasSoc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtSociedad_KeyDown(sender As Object, e As KeyEventArgs) Handles txtSociedad.KeyDown
        ...
        If e.KeyCode = Keys.F1 Then
            senial = 5
            Dim frmSoc5 As New frmConsSociedad
            AddOwnedForm(frmSoc5)
            frmSoc5.ShowDialog()
            senial = 0
        End If
    ...
    Private Sub LeerSociedades()
        ...
        If dt.Rows.Count > 0 Then
            ...
            txtNombre.Text = CStr(row("NombSociedad"))
        Else
            txtNombre.Text = ""
        ...
        comando.CommandText = "SELECT * FROM boletas WHERE MatBoleta = " & txtSociedad.Text & " ORDER BY FecVtoBoleta"
        dt = New DataTable
        da = New MySqlDataAdapter(comando)
        da.Fill(dt)
    ...
    Private Sub dgvBoletas_DoubleClick(sender As Object, e As EventArgs) Handles dgvBoletas.DoubleClick
        ...
        If longitud < 5 Then
            ...
            For i = 1 To cantidad
                ceros = ceros & "0"
            Next i
            txtSociedad.Text = ceros & dgvBoletas.CurrentRow.Cells(0).Value.ToString
        End If
    ...
    Private Sub btnReliquidar_Click(sender As Object, e As EventArgs) Handles btnReliquidar.Click
        ...
        CodigoArmado = ArmaCodigoBarra(txtSociedad.Text, MMperiodo, YYYYperiodo, total, dd, mm, yy)

        comando.CommandText = "UPDATE boletas SET FecVtoBoleta = '" & fechavto & "', CodigoBoleta = '" & CodigoArmado & "' WHERE MatBoleta = " & txtSociedad.Text & " AND PeriodoBoleta = " & periodo & ""
        ...
        If longitud < 5 Then
            ...
            For i = 1 To cantidad
                ceros = ceros & "0"
            Next i
            txtSociedad.Text = ceros & txtSociedad.Text
        End If

        nombrePDF = txtSociedad.Text & "-" & dgvBoletas.CurrentRow.Cells(7).Value.ToString
    ...
    Private Sub MoverDatos()
        ...
        parametros(0) = New ReportParameter("prmMatricula", txtSociedad.Text)
        ...
        parametros(20) = New ReportParameter("prmCodigoDePago", dgvBoletas.CurrentRow.Cells(22).Value.ToString)
