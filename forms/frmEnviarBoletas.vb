...
Public Class frmEnviarBoletas
    ...
    Private Sub btnImprimir_Click(sender As Object, e As EventArgs) Handles btnImprimir.Click
        ...
        For Each row In dt.Rows
            ...
            If senial = 1 Then
                ...
                comando = New MySqlCommand("UPDATE ctasctes SET EstadoCC = 'PENDIENTE' WHERE MatBoleta = " & matricula & " AND PeriodoCC = '" & periodo & "'", conexion)
                comando.ExecuteNonQuery()
                fila = fila + 1
                senial = 0
            End If
    ...
    Private Sub Imprimir()
        ...
        For i = 0 To fila
            ...
            parametros(38) = New ReportParameter("prmTipoNro2", "MATRÍCULA:")
            parametros(39) = New ReportParameter("prmTipoNom2", "MCP:")
            parametros(61) = New ReportParameter("prmCodigoDePago1", CStr(tabla(i, 19)))
            ...
            parametros(58) = New ReportParameter("prmTipoNro3", "MATRÍCULA:")
            parametros(59) = New ReportParameter("prmTipoNom3", "MCP:")
            parametros(62) = New ReportParameter("prmCodigoDePago1", CStr(tabla(i, 19)))
