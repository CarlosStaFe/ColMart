...
Public Class frmLiquidarMat
    ...
    Dim cto, codbarra, codigodepago As String
    ...
    Private Sub btnProcesar_Click(sender As Object, e As EventArgs) Handles btnProcesar.Click
        ...
        comando.CommandText = "SELECT * FROM matriculados WHERE NroMatri >= '" & txtDesdeMat.Text & "'  AND NroMatri <= '" & txtHastaMat.Text & "' "
        dt = New DataTable
...
seguir:
            ...
            codigopostal = CStr(row("CPRealMatri"))
