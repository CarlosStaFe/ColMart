...
#Region "Menu Sociedades"
    ...
    Private Sub btnListaPadronSoc_Click(sender As Object, e As EventArgs) Handles btnListaPadronSoc.Click

        MostrarHijo(frmPadronSoc)
        OcultarSubmenu()

    End Sub

    Private Sub btnSaldoPagoSoc_Click(sender As Object, e As EventArgs) Handles btnSaldoPagoSoc.Click

        MostrarHijo(frmSaldoPagoSoc)
        OcultarSubmenu()
...
#Region "Menu Mesa"
    Private Sub btnMesaEntrada_Click(sender As Object, e As EventArgs) Handles btnMesaEntrada.Click

        MostrarSubmenu(SubMenuMesa)

    End Sub

    Private Sub btnActualizarMesa_Click(sender As Object, e As EventArgs) Handles btnActualizarMesa.Click

        MostrarHijo(frmMesaEntrada)
        OcultarSubmenu()
...
#Region "Menu Parámetros"
    Private Sub btnParametros_Click_1(sender As Object, e As EventArgs) Handles btnParametros.Click
    ...
    Private Sub btnCodDebitar_Click_1(sender As Object, e As EventArgs) Handles btnCodDebitar.Click
    ...
    Private Sub btnTribunal_Click_1(sender As Object, e As EventArgs) Handles btnTribunal.Click
...
#Region "Menu Sistema"
    Private Sub btnSistema_Click_1(sender As Object, e As EventArgs) Handles btnSistema.Click
